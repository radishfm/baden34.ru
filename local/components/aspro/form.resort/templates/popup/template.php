...
$(document).ready(function(){
	...
	$('.popup form[name="<?=$arResult["IBLOCK_CODE"]?>"] input.datetime').inputmask(arResortOptions['THEME']['DATETIME_MASK'], { 'placeholder': arResortOptions['THEME']['DATETIME_PLACEHOLDER'] });
