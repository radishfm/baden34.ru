...
$(document).ready(function(){
	...
	$('.inline form[name="<?=$arResult["IBLOCK_CODE"]?>"] input.datetime').inputmask(arResortOptions['THEME']['DATETIME_MASK'], { 'placeholder': arResortOptions['THEME']['DATETIME_PLACEHOLDER'] });
